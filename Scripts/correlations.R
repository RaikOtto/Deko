...
saveRDS(endocrine_corr_ki67, file = "~/Praktikum/corr_res/endocrine_cor_ki67.RDS")
saveRDS(endocrine_corr_grading, file = "~/Praktikum/corr_res/endocrine_cor_grading.RDS")
saveRDS(exocrine_corr_ki67, file = "~/Praktikum/corr_res/exocrine_cor_ki67.RDS")
saveRDS(exocrine_corr_grading, file = "~/Praktikum/corr_res/exocrine_cor_grading.RDS")

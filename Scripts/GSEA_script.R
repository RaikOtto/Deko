...
write.table(cls_file, "~/SeneSys/GSEA/GSE98588_new.ABC_GCB.cls",row.names = F, quote = F, sep ="\t",col.names = FALSE)
write.table(cls_file, "~/SeneSys/GSEA/GSE98588_new.ABC_GCB.cls.tsv",row.names = F, quote = F, sep ="\t",col.names = FALSE)
...
write.table(output_gct, "~/SeneSys/GSEA/GSE98588_new.ABC_GCB.gct",row.names = F, quote = F, sep ="\t",col.names = FALSE)
write.table(output_gct, "~/SeneSys/GSEA/GSE98588_new.ABC_GCB.gct.tsv",row.names = F, quote = F, sep ="\t",col.names = FALSE)

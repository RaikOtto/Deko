...
path_transcriptome_file = "~/MAPTor_NET/BAMs_new/RepSet_S103.HGNC.tsv"
...
expr = expr_raw[,meta_data$Histology_Primary %in% c("Pancreatic")]
...
write.table(cls_file, "~/Deko_Projekt/GSEA/RepSet.S71.pancreas_only_NEC_vs_NET.DESeq2.cls",row.names = F, quote = F, sep ="\t",col.names = FALSE)
write.table(cls_file, "~/Deko_Projekt/GSEA/RepSet.S71.pancreas_only_NEC_vs_NET.DESeq2.cls.tsv",row.names = F, quote = F, sep ="\t",col.names = FALSE)
...
write.table(output_gct, "~/Deko_Projekt/GSEA/RepSet.S71.pancreas_only_NEC_vs_NET.DESeq2.gct",row.names = F, quote = F, sep ="\t",col.names = FALSE)
write.table(output_gct, "~/Deko_Projekt/GSEA/RepSet.S71.pancreas_only_NEC_vs_NET.DESeq2.gct.tsv",row.names = F, quote = F, sep ="\t",col.names = FALSE)

...
groetzinger_counts = read.table("~/MAPTor_NET/BAMs/Kallisto_three_groups/TPMs.Non_Norm.kallisto.Groetzinger.tsv",sep ="\t", header = T)
scarpa_counts = read.table("~/MAPTor_NET/BAMs/Kallisto_three_groups/TPMs.Non_Norm.kallisto.Scarpa.tsv",sep ="\t", header = T)
#bam_counts = read.table("~/MAPTor_NET/RAW/Raw_counts.81_samples_Scarpa_Groetzinger.tsv",sep ="\t", header = T)
bam_counts = cbind(groetzinger_counts, scarpa_counts)

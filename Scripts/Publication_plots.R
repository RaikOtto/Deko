...
aka3 = list(
  ...
  Progenitor_sim = c(low = "white", medium = "yellow", high = "orange"),
  Differentiated_sim = c(low = "white", medium = "yellow", high = "darkgreen"),
  HSC_sim = c(low = "white", medium = "yellow", high = "darkred"),
